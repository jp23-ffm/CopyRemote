...
# Keep IN(...) clauses well under SQLite's bound-variable limit.
...
def export_to_file_grouped(request, filetype):
    ...
    # Filter the servers based on the filters and permanent filter.
    # Ordered by SERVER_ID so rows for the same server are contiguous — the
    # grouped export streams this ordering instead of loading every Server
    # row into a dict upfront.
