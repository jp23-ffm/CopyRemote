...
urlpatterns = [
    ...
    path('history/', views.historic_breakdown_view, name='historic_breakdown_view'),
    path('history/export/', views.historic_breakdown_export, name='historic_breakdown_export'),
    path('history/export/recap/', views.historic_breakdown_export_recap, name='historic_breakdown_export_recap'),
