...
from .serializers import (
    ...
    InventoryServerSerializer, ServerDiscrepancySerializer,
)
...
class SrvPropView(APIView):
    ...
    MAX_ENRICH_RESULTS = 50_000
    MAX_UNIFY_RESULTS = 100_000
    MAX_GROUP_RESULTS = 50_000
    ...
    @extend_schema(
        ...
        description=(
            ...
            "**ANNOTATION**: virtual field available only on the `inventory` index."
        ),
        ...
        examples=[
            ...
            OpenApiExample(
                "With exclusion and wildcard",
                value={
                    "index": "businesscontinuity",
                    "filters": {"DATACENTER": ["!*TEST*"], "ITCONTINUITY_LEVEL": ["GOLD", "SILVER"]},
                },
                request_only=True,
            ),
        ],
    ...
    def post(self, request):
        try:
            ...
            api_log(f"Payload: {_truncate_payload_for_log(request.data)}")
...
class QueryBuilderView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        current_dir = os.path.dirname(__file__)
        fields_data = {}
        for app in ('inventory', 'businesscontinuity', 'discrepancies'):
