...
class AnalysisSnapshotBreakdown(models.Model):
    ...
    One row per (snapshot, dimension, dimension_value) — feeds the historic table view
    and its Excel export. The list of dimensions is config-driven, see
    discrepancies/breakdown_groups.json ("dimensions") — dimension is any Server field
    ...
    # {field_name: count, ...} — missing-field / inconsistency breakdown for this slice
