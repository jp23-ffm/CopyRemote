...
def _compute_days_open(tracker, filtered_fields=None):
    # Return days_open for a tracker instance:  If filtered_fields is provided and has matching active issues, return the max days_open among those fields (context-sensitive)
