...
urlpatterns = [
    ...
    # EXPERIMENTAL: same page, listbox values served from the DB-backed cache
    # instead of LocMemCache — for side-by-side comparison. See views_dbcache.py.
    path('servers-dbcache/', views_dbcache.server_view, name='server_view_dbcache'),
