...
def dashboard(request):
    if not has_perm(request.user, 'accessrights.admin'):
...
def get_config(request):
    ...
    # App definitions (keys, labels, colors) come from permissions.json, Users + their active permissions come from the database.
    ...
    try:
        ...
        print(f"permissions.json not found at {json_path}")
