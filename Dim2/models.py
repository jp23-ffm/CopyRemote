...
class DiscrepancyTracker(models.Model):
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(fields=['SERVER_ID'], name='disctracker_serverid_uniq'),
        ]
        indexes = [
            models.Index(fields=['oldest_first_seen'], name='disctracker_oldest_idx'),
        ]
...
class ExcludedServer(models.Model):
    """
    Servers manually excluded from discrepancy analysis.
    Managed via the dashboard UI (add/delete/export).
    """
