...
urlpatterns = [
    ...
    path('pamela/dashboard/', views.pamela_dashboard_view, name='pamela_dashboard_view'),
    path('pamela/servers/', views.pamela_server_view, name='pamela_servers'),
    path('pamela/api/trend/', views.pamela_trend_api_view, name='pamela_trend_api'),
    path('pamela/api/dashboard-filter/', views.pamela_dashboard_filter_api, name='pamela_dashboard_filter_api'),
    path('pamela/export/<str:filetype>/', views.pamela_export_to_file, name='pamela_export_to_file'),
    path('pamela/dashboard/export/', views.pamela_dashboard_export_excel, name='pamela_dashboard_export_excel'),
    path('pamela/charts/', views.pamela_chart_view, name='pamela_chart_view'),
    path('pamela/bulk_annotation/', views.pamela_bulk_annotation, name='pamela_bulk_annotation'),
    path('pamela/save_search/', views.pamela_save_search, name='pamela_save_search'),
    path('pamela/load_search/<int:search_id>/', views.pamela_load_search, name='pamela_load_search'),
    path('pamela/delete_search/<int:search_id>/', views.pamela_delete_search, name='pamela_delete_search'),
