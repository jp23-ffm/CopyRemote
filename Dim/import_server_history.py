...
from inventory.models import Server, ServerHistory

logger = logging.getLogger(__name__)

TRACKED_FIELDS = [
    'APP_CRITICALITY', 'ENVIRONMENT', 'OSSHORTNAME', 'OSFAMILY', 'REGION',
    'SNOW_DATACENTER', 'MACHINE_TYPE', 'MANUFACTURER', 'SNOW_STATUS',
    'CPU', 'RAM',
]
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        fields = [
            ...
            'APP_CRITICALITY', 'ENVIRONMENT', 'OSSHORTNAME', 'OSFAMILY',
            'REGION', 'SNOW_DATACENTER', 'MACHINE_TYPE',
            'MANUFACTURER', 'SNOW_STATUS', 'CPU', 'RAM',
        ]
        ...
        self.stdout.write(
            f'  New: {len(current_keys - open_keys):,}  '
            f'Changed: {n_changed:,}  '
            f'Disappeared: {len(open_keys - current_keys):,}'
        )
