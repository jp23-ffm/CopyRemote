...
class SavedHistoryQuery(models.Model):
    """Persisted query spec for the History Query Builder."""
    user_profile = models.ForeignKey(UserProfile, on_delete=models.CASCADE, related_name='saved_history_queries')
    name = models.CharField(max_length=100)
    spec = models.JSONField()  # {measure_field, measure_agg, group_by, filters, start, end, step, top_n}
